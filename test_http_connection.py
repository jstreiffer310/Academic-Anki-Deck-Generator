#!/usr/bin/env python3
"""
Test AnkiConnect connection using HTTP (not HTTPS)
"""
...
ANKI_URL = "http://glowing-space-dollop-wr5r957xv9wqfgq6g-8765.app.github.dev/"

def test_anki_connection():
    print("🧪 Testing AnkiConnect via HTTP...")
    print("=" * 50)
